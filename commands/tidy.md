...
- Be sure our barrel files are tight and clean, and our imports use them
...
- No unused imports
- In tests prefer the BDD-style Given-when-then group and test string naming.
- In tests use the 'shoudly' package for test assertions whenever possible.
